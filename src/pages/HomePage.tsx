...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 2027 primaries — same official National Secretariat poster as /elections/2027-primaries */}
      <section
        aria-labelledby="primaries-notice-home-heading"
        className="relative overflow-hidden border-b border-gray-100/90 bg-gradient-to-br from-[#158a50]/10 via-white to-[#ef8636]/[0.08] px-4 py-9 sm:px-6 sm:py-11 md:py-12"
      >
        <div className="pointer-events-none absolute -right-20 top-8 h-48 w-48 rounded-full border-2 border-[#ef8636]/15 sm:right-10 sm:top-4 sm:h-72 sm:w-72" aria-hidden />
        ...
        <div className="relative z-10 mx-auto max-w-5xl">
          <h2 id="primaries-notice-home-heading" className="sr-only">
            {PRIMARIES_NOTICE_DOCUMENT_TITLE}
          </h2>
          <div className="sdp-primaries-notice-print-scope homepage-primaries-anchor overflow-hidden rounded-3xl border-2 border-[#1daa62]/35 bg-white shadow-xl shadow-[#158a50]/12">
            <Primaries2027PosterBlock variant="home" />
          </div>
        </div>
      </section>
