  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn("text-sm font-medium", props.captionLayout && props.captionLayout !== "buttons" && "hidden"),
        caption_dropdowns: "flex justify-center gap-1",
        dropdown: "px-2 py-1 rounded-md bg-transparent text-sm font-medium hover:bg-accent hover:text-accent-foreground outline-none border-none cursor-pointer appearance-none [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:display-none",
        dropdown_month: "flex-1 min-w-[100px]",
        dropdown_year: "flex-1 min-w-[80px]",
